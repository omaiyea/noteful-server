...
const { makeNotesArray, makeNewNote, makeUpdatedNote, makeFakeNote } = require('./fixtures/notes.fixtures');
    ...
    describe(`DELETE /api/notes`, () => {
        ...
        context(`Given notes in the database`, () => {
            ...
            it(`responds with 200 when note in database is deleted`, () => {
                ...
                const remainingNotes = testNotes.filter(note => {note.note_id !== deleteNoteId});
