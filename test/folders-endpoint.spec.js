    ...
    describe(`POST /api/folders`, () => {
        it(`responds with 200 and the created folder`, () => {
            ...
            return supertest(app)
             ...
             .send(testFolder)
             .expect(201)
             .expect(res => { expect(res.body.folder_name).to.eql(testFolder.folder_name)} );
        });
    });
    ...
    describe(`DELETE /api/folders`, () => {
        ...
        context(`Given folders in the database`, () => {
            ...
            it(`responds with 200 when folder in database is deleted`, () => {
                ...
                const remainingFolders = testFolders.filter(folder => {folder.folder_id !== deleteFolderId});
                ...
                return supertest(app)
                 ...
                 .then(() => {
                     supertest(app)
                      ...
                      .expect(201)
                      .expect(res => { expect(res.folder_name).to.eql(updatedFolder.folder_name) })
                 });
            });
        });
    });
